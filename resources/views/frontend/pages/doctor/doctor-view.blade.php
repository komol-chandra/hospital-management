            ...
            <div class="col-md-12" style="padding: 30px;">
                ...
                "settings": {
                    ...
                    <div class="js-slide px-3">
                        <div class="row">
                            <div class="col-sm-12">
                                <img class="img-fluid rounded mx-auto" src="/{{ $doctor->users->picture }}"  alt="Alison Frami" style="height: 150px; width: 150px;">
                            </div>
                            <div class="col-sm-6 d-sm-flex align-content-sm-start flex-sm-column text-center text-sm-left mb-7 mb-sm-0">
                                <div class="w-100">
                                    <h3 class="h5 mb-4">{{ $doctor->users->name }}</h3>
                                </div>
                                <div class="d-inline-block">
                                    <span class="badge badge-primary badge-pill badge-bigger mb-3">{{ $doctor->departments->name }}</span>
                                </div>
                                <p class="font-size-1">Email: <span>{{ $doctor->users->email }}</span></p>
