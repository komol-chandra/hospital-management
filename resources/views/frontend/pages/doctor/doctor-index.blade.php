    ...
    <div class="bg-light">
        <div class="container space-2 space-md-2">
            ...
            {{-- <div class="row">
                ...
                <div class="col-md-6">
                    <label for=""><h5>Select Department</h5></label>
                        ...
                        <div class="js-slide px-3">
                            <div class="row">
                                <div class="col-sm-6 d-sm-flex align-content-sm-start flex-sm-column text-center text-sm-left mb-7 mb-sm-0">
                                    <div class="w-100">
                                        <h3 class="h5 mb-4">{{ $value->users->full_name }}</h3>
                                    </div>
                                    <div class="d-inline-block">
                                        <span class="badge badge-primary badge-pill badge-bigger mb-3">{{ $value->departments->name }}</span>
                                    </div>
                                    <p class="font-size-1">Email: <span>{{ $value->users->email }}</span></p>
                                ...
                                <div class="col-sm-5">
                                    <img class="img-fluid rounded mx-auto" src="/{{ $value->users->picture}}"  alt="Alison Frami" style="border-radius: 100px !important;">
                                </div>
                                
                            </div>
                            <a href="{{url('frontend/doctor-view/'.$value->id)}}" class="btn btn-info btn-sm mt-3">View Doctor</a>
                        </div>
                    </div>
                </div>
                @empty
