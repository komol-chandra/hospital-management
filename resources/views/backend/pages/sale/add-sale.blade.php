                    ...
                    <div class="col-sm-12 ">
                        <div class="col-sm-12 panel panel-bd">
                            ...
                            <div class="col-sm-6 form-group">
                                <select id="type_id" class="form-control type_id" name="type_id" onchange="getSearch()">
                            ...
                            <div class="col-sm-6 form-group">
                                <select id="generic_id" class="form-control generic_id" name="generic_id" onchange="getSearch()">
                            ...
                            <div class="col-sm-12 form-group">
                                <input type="text" name="search" class="form-control search" id="search" placeholder="search medacine name,sku" onchange="getSearch()">
                            </div>
                        </form>
                        ...
                        <table class="table table-striped">
                            <tfoot>
                                <tr class="bg-success">
                                    ...
                                    <th><select id="customer_id" class="form-control customer_id" name="customer_id" onchange="getSearch()">
                                        <option value=""> Customer Type</option>
                                        @foreach($customers as $data)
                                        <option value="{{ $data->id }}">{{ $data->phone }}({{ $data->name }})</option>
                                        @endforeach
                                    </select></th>
                                    <td></td>
                                </tr>
                                ...
                                <tr class="bg-danger">
                                    ...
                                    <th><input type="number" name="discounted_amount" required="" autocomplete="off" id="discount" class="discount form-control" placeholder="Discount" value="0.00"></th>
                                    <td></td>
                                </tr>
        ...
        medicineArray.forEach((value,index)=>{
            loop_html += `<tr>
                        <td class="text-center" style="max-width: 1rem; width:1rem;">
                            <select name="" id="" class="form-control"   onChange="getBatch(${index})">
