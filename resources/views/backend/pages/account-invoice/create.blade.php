...
@section('content')
@section('title', '| Create Account Invoice')
@section('header-title', 'Create Account Invoice')
@section('breadcrumb', 'Create Account Invoice')
    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            <div class="panel-body">
                <div class="col-sm-12">
                    {!! Form::open(['url' => '/admin/account-invoice','method'=>'post','files'=>true]) !!}
                        @include('backend.pages.account-invoice.form')
...
{{-- <script src="{{asset('backend/script/account-invoice.js')}}"></script> --}}
<script>
