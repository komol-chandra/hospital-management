<div class="panel panel-default thumbnail">
    <div class="panel-heading no-print">
        <div class="btn-group">
            <a class="btn btn-primary" href="{{ url('/admin/account-invoice') }}"> <i class="fa fa-list"></i>Account Invoice List</a>
    ...
    <div class="col-md-11 ">
        <table>
          <tr>
              ...
              <td>
                <input type='text' name='description[]' class='form-control' style='margin-left: 9px; width: 280px;' placeholder="Description">
              </td>
              <td>
