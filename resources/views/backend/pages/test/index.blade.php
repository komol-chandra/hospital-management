    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="btn-group"> 
                    {{-- <a class="btn btn-success" href="{{ url('/admin/appointment/create') }}"> <i class="fa fa-plus"></i> Add Test
                    </a> --}}
                    <button type="button" class="btn btn-success m-r-2 m-b-5" data-toggle="modal" data-target="#modal-success"><i class="fa fa-plus"></i> Add New Test</button>  
                </div>        
            </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $value->lab_name ?? null}}</td>
                                <td>{{ $value->prize ?? null}} <b>৳</b></td>
                                ...
                                <td>
                                    @if($value->status == 1)
                                    <a class="btn btn-danger btn-xs" id="status" href="/admin/test/status/{{ $value->id }}"><i class="fa fa-refresh"></i></a>
                                    @else
                                    <a class="btn btn-info btn-xs" id="status" href="/admin/test/status/{{ $value->id }}"><i class="fa fa-refresh"></i></a>
                                    @endif
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h1 class="modal-title">Add Test</h1>
            </div>
            <div class="modal-body">
            {!! Form::open(['url' => '/admin/test','method'=>'post','files'=>true,'id'=>'form_insert']) !!}
...
<div class="modal fade modal-success" id="modal-edit" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
            {!! Form::open(['url' => '/admin/test/'.$data['id'].'','method'=>'put','files'=>true,'id'=>'form_update']) !!}
    ...
    iziToast.question({
        ...
        buttons: [
            ['<button><b>YES</b></button>', function () {
                ...
                $form.attr('action','/admin/test/'+id);
                $form.submit()
            }, true],
...
<script src="{{asset('backend/script/test.js')}}"></script>
@endsection