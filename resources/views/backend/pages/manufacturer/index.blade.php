...
@section('header-title', 'Manufacturer')
@section('breadcrumb', ' Manufacturer')
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="btn-group">
                    <button type="button" class="btn btn-success m-r-2 m-b-5" data-toggle="modal" data-target="#modal-success"><i class="fa fa-plus"></i> Add New Manufacturer</button>  
                </div>        
            </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($value->status == 1)
                                    <a class="btn btn-danger btn-xs" id="status" href="/admin/manufacturer/status/{{ $value->id }}"><i class="fa fa-refresh"></i></a>
                                    @else
                                    <a class="btn btn-info btn-xs" id="status" href="/admin/manufacturer/status/{{ $value->id }}"><i class="fa fa-refresh"></i></a>
                                    @endif
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h1 class="modal-title">Add Manufacturer</h1>
            </div>
            <div class="modal-body">
            {!! Form::open(['url' => '/admin/manufacturer','method'=>'post','files'=>true,'id'=>'form_insert']) !!}
    ...
    iziToast.question({
        ...
        buttons: [
            ['<button><b>YES</b></button>', function () {
                ...
                $form.attr('action','/admin/manufacturer/'+id);
                $form.submit()
            }, true],
...
<script src="{{asset('backend/script/manufacturer.js')}}"></script>
@endsection